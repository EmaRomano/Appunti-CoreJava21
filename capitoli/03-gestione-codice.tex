...
\begin{warning}[Package vs Directory: Distinzione Concettuale]
...
\begin{warning}[Compilazione ed Esecuzione: File vs Classi]
...
\begin{warning}[Regola d'oro dell'Incapsulamento]
...
\begin{warning}[La regola del pacchetto singolo]
