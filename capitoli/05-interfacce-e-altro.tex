...
\begin{itemize}
    ...
    \item \textbf{Controllo dei tipi (\texttt{Pattern Matching})}: Il meccanismo per verificare l'appartenenza a un tipo è identico sia utilizzando \texttt{instanceof} che \texttt{Switch}.
\end{itemize}
\vspace{\baselineskip}
