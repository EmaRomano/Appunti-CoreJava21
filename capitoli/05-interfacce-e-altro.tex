...
La sintassi si adatta alla complessità del compito. Ecco uno schema riassuntivo:

\begin{table}[ht]
\centering
\begin{tabular}{|l|l|}
\hline
\textbf{Scenario} & \textbf{Esempio di Sintassi} \\ \hline
Standard (2+ parametri) & \texttt{(a, b) -> Integer.compare(a, b)} \\ \hline
Parametro singolo & \texttt{x -> x * x} \\ \hline
Senza parametri & \texttt{() -> System.out.println("Hello")} \\ \hline
Blocco multi-riga & \texttt{(x, y) -> \{ int sum = x + y; return sum; \}} \\ \hline
Parametro ignorato & \texttt{\_ -> System.out.println("Evento loggato")} \\ \hline
\end{tabular}
\end{table}
