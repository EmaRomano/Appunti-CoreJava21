...
%     % Esempio da aggiungere alla nota quando la inserirai
%     \begin{example}
%     Il codice sorgente:
%     \begin{lstlisting}[language=Java]
%     public T getFirst() { return first; }
%     \end{lstlisting}
%     Dopo la \textit{Type Erasure}, diventa:
%     \begin{lstlisting}[language=Java]
%     public Object getFirst() { return first; }
%     \end{lstlisting}
%     Il compilatore aggiunge poi il cast invisibile nel punto in cui il metodo viene chiamato.
%     \end{example}
% \end{tip}
...
public static <T extends Comparable> T min(T[] a) {
    // Ora il compilatore sa che T ha il metodo compareTo()
