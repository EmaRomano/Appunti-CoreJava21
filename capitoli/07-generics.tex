...
\begin{warningbox}[Firma del Metodo: Java vs JVM]
    ...
    \begin{itemize}
        \item \textbf{Java Language}: Un metodo è identificato univocamente dalla sua \textit{signature} (nome e tipi dei parametri). Il tipo di ritorno viene ignorato per evitare ambiguita' durante l'invocazione.
